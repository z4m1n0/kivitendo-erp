...
__PACKAGE__->meta->columns(
  ...
  rec_id                     => { type => 'integer', not_null => 1 },
  rec_reason_description_ext => { type => 'text' },
  rec_reason_description_int => { type => 'text' },
  rec_reason_id              => { type => 'integer', not_null => 1 },
  reqdate                    => { type => 'date' },
...
__PACKAGE__->meta->foreign_keys(
  ...
  rec_reason => {
    ...
    key_columns => { rec_reason_id => 'id' },
  },

  reclamation => {
    class       => 'SL::DB::Reclamation',
    key_columns => { rec_id => 'id' },
  },
