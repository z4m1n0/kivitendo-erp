...
my @link_type_specifics = (
  ...
  { title => t8('Sales Reclamation'),       type => 'sales_reclamation',       model => 'Reclamation',     number => 'rec_number',},
  ...
  { title => t8('Purchase Reclamation'),    type => 'purchase_reclamation',    model => 'Reclamation',     number => 'rec_number',},
